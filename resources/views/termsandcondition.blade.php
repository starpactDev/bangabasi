		...
		<div  class="font-mono leading-relaxed col-span-12 lg:col-span-12">
			...
			<div class="grid grid-cols-12 gap-8">
				<div class="col-span-12 lg:col-span-6">
					<p class="typewriter-none font-semibold" data-text="">Type of information collected through the Web site  Personal Information: </p>
					<p class="typewriter-none ml-8" data-text="">Users registering at the BANGABASI site for specific services are requested to provide some personally identifiable information which become the property of BANGABASI and can be shared, disclosed or distributed to third parties only in accordance with the Privacy Policy. Please take note that registration is not required for visitors to the site who do not require any specific services BANGABASI will not sell or rent such personally identifiable information collected. The personally identifiable information is supplied voluntarily for some of the following purposes:</p>
					<p class="typewriter-none ml-16" data-text="">Registration Data - If you are merely a visitor to our site, BANGABASI does not collect any personal information about you, except to the limited extent through the use of cookies, as described below. If you decide to use certain services offered on the site, you will be asked to register. During registration you will be requested to complete a registration form setting out basic online contact information about yourself.</p>
					<p class="typewriter-none ml-16" data-text="">Other Optional Information: If you wish to subscribe to BANGABASI publications, newsletters, etc., you will be required to fill up certain personal information related to your email address, name, country, age, choice of password, etc. However, for any of the other services such as registration for membership, etc. filling up the relevant form is mandatory.</p>
					<p class="typewriter-none ml-16" data-text="">Credit Card Information: If you purchase BANGABASI publications at the Site or register for an event, you will be required to submit your credit card details, including your name, account number and the expiration date. The information is used for billing purposes and to contact you if there are difficulties in processing your order. BANGABASI uses / will use a credit card processing company to bill users for goods and services which will not retain, share, store or use personally identifiable information for any secondary purposes.</p>
					<p class="typewriter-none ml-16" data-text="">E-mail Information: When we receive e-mails from you, we may retain the content of any e-mail messages sent to us, as well as details of your e-mail address.</p>
				</div>
				<div class="col-span-12 lg:col-span-6">
					<p class="typewriter-none font-semibold" data-text="">Use of web-based tracking mechanisms such as Cookies: </p>	
					<p class="typewriter-none ml-4" data-text="">Cookies, which enable us to store small amounts of information contained in your Web site browser, may be used on some areas of our Website. Cookies, that help us track your navigation, enable us to tailor our offerings to your needs. The kind of information that may be stored on a cookie includes registration data so that a user does not need to re-enter the information every time he/she visits a particular area. The information contained on cookies is masked to ensure your privacy and is readable only by the servers of BANGABASI. Third party Websites which are accessible from our Site via links, click-throughs or banner advertising may use Cookies. However, it is important for us to inform you that we have no access or control over such Cookies and do not accept responsibility with regards to them.</p>
					<p class="typewriter-none-none" data-text="">Choice/opt out: BANGABASI gives you the choice regarding the collection and usage of your personally identifiable information. During registration for “joining our mailing list,” we request for contact information in order to send bulletins and for advertising purposes. Again, it is not necessary for you to register in order to access and use our Site. You may therefore choose to opt out of providing such information. Further, once you are registered at the BANGABASI’s site, you will have the option at any stage to inform us that you no longer wish to receive future e-mails and you may “unsubscribe.”</p>
				</div>
			</div>
...
<script>
	...
	startSequentialTypewriter('.typewriter', 1);
</script>
@endpush