...
<head>
	...
	<title>Bangabasi-Seller Dashboard</title>
		...
		<div class="ec-page-wrapper">
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user-menu">
								...
								<ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
									...
									<li>
										<a href="{{route('admin_profile')}}"> <i class="mdi mdi-account"></i> My Profile </a>
									</li> 
			...
			<footer class="footer mt-auto">
				<div class="copyright bg-white">
					<p> Copyright &copy; <span id="ec-year"></span><a class="text-primary" href="" target="_blank"> Starpact Seller Dashboard</a>. All Rights Reserved. </p>
				</div>
			</footer>
			<!-- End Footer -->
