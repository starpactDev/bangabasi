    ...
    <div class="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
            ...
            <div class="mt-5 space-y-4">
                <p class="text-lg"><strong class="text-orange-500">Address:</strong> 0050 Gita Kuthir, Burdwan, WB 713125, India</p>
                <p class="text-lg"><strong class="text-orange-500">Phone & WhatsApp:</strong> +91 94761 68391</p>
            </div>
        </div>
        <div>
