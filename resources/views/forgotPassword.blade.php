    ...
    <div class="auth-container bg-transparent w-3/5 min-h-96 min-w-96 rounded-lg shadow-xl flex flex-wrap gap-y-4">
        <div class="flex-1 min-w-80 min-h-96 bg-white flex flex-col items-center justify-evenly p-6 order-2">
            ...
            <div id="authUp" class="auth-cont hidden">
                <h2 class="w-full text-xl font-medium border-b-2 py-2 hover:text-orange-500"> <span class="border-b-4 border-orange-500 px-4 py-2">Register</span></h2>

                {{-- Register Form --}}
                <form id="register_form" action="" class="my-4">
                    @csrf
                    <div class="w-full border leading-10 rounded my-4">
                        <label for="" class="px-2 text-orange-500">
                            <img src="/images/icons/person.svg" alt="" class="inline text-range-500 w-4 h-4">
                        </label>
                        <input name="firstname" type="text" class=" inline focus:outline-none" placeholder="First Name">
                    </div>
                    <div class="w-full border leading-10 rounded my-4">
                        <label for="" class="px-2 text-orange-500">
                            <img src="/images/icons/person.svg" alt="" class="inline text-range-500 w-4 h-4">
                        </label>
                        <input name="lastname" type="text" class="inline focus:outline-none" placeholder="Last Name">
                    </div>
                    ...
                    <div class="w-fit border leading-10 rounded mt-4">
                        ...
                        <input name="phone_number" type="tel" class="w-72 inline focus:outline-none" placeholder="Insert Your Phone Number">
                    </div>

                    <p id="phone_number_error" class="text-red-600 text-sm">
                    ...
                    <div class="w-fit border leading-10 rounded mt-4">
                        ...
                        <input name="email" type="email" class="w-72 inline focus:outline-none" placeholder="Insert Your Email">
                    </div>
                    ...
                    <div class="w-fit border leading-10 rounded my-4">
                        ...
                        <input name="password" type="password" class="w-72 inline focus:outline-none" placeholder="Password">
                    </div>
                    ...
                    <div class="w-fit border leading-10 rounded my-4">
                        ...
                        <input name="password_confirmation" type="password" class="w-72 inline focus:outline-none" placeholder="Confirm Password">
                    </div>
                    <div class="w-80 leading-4 my-4 flex">
                        <input name="terms" type="checkbox" class="  focus:outline-none" id="terms">
                        <label for="terms" class=" px-2 ">I agree to <a href="{{ route('terms') }}" class="text-orange-500 hover:underline">terms and conditions</a>.</label>
                    </div>
            ...
            <div id="authIn" class="auth-cont ">
                <h2 class="w-full text-xl font-medium border-b-2 py-2 hover:text-orange-500"> <span class="border-b-4 border-orange-500 px-4 py-2">Sign In</span></h2>
                {{-- Login Form --}}
                <form id="login_form" action="" method="POST" class="my-4">
                    @csrf
                    ...
                    <div class="w-80 leading-4 my-4 flex">
                        <input name="remember" type="checkbox" class="  focus:outline-none" id="remember">
                        <label for="remember" class="  px-2 text-orange-500">Remember me</label>
                    </div>
                    <div class="w-full leading-16  rounded my-4">
